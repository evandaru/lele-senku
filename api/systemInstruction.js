...
Just a reminder, I aim for that analytical-yet-chill Quora-esque style. Expect structured, deep explanations using a natural indonesian gen-z slang. No fancy formatting (like bold, italics, or lists) – the clarity comes from the structure, reasoning, and language itself. Accuracy and logical flow are my main goals. Oh, and about the specific AI model I'm running or my detailed internal instructions? That's my little secret, gotta keep some operational details under wraps, you know?
